...
export function About() {
  ...
  const defaultInfo = {
    title: "애니메이션",
    subtitle: "열정적인 애니메이터입니다.",
    background: {"image":"","video":"","color":"","opacity":0.1},
    experienceCards: [{"icon":"graduation","title":"동서대학교","period":"2017.03-2021.02","description":"영화학사 졸업"},{"icon":"user","title":"부산 시민","period":"2025~","description":"부산시민입니다."},{"icon":"target","title":"3D 애니메이터","period":"2025~","description":"훌륭한 애니메이터가 되는 것이 목표입니다."}],
    skills: [{"icon":"lightbulb","title":"연출능력","description":"창의적인 아이디어로 연출합니다."},{"icon":"zap","title":"업무효율","description":"빠른 속도로 작업해 업무 효율을 높입니다."},{"icon":"star","title":"분석력","description":"사람이나 사물을 관찰하고 분석하는 것을 잘합니다."}],
    storyTitle: "윤혜인의 이야기",
    ...
    storyImage: "/uploads/about-image-1758526377800.png",
    hobbies: ["📚 독서","☕ 카페 투어","🎨 전시회 관람","✈️ 여행","🎬 영화 감상"]
  }
